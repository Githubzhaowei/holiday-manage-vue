<template>
    <div style="text-align: center; clear: both; overflow: hidden;">
        <h1 class="title" style="color: black;">404<el-button plain @click="goHome">返回首页</el-button></h1>
    </div>
</template>
    ...
    /*    mounted() {
        ...
        class Plant {
            constructor(x, y, l) {
                ...
                this.thickness =
                    Util.map(this.length, H, 0, this.min_thickness, this.max_thickness) * Util.random(0.8, 1.2);
                this.z_value = 0;
